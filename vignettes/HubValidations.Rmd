...
validate_model_metadata(
  system.file("testdata", "model-metadata", "metadata-example-model.yml", package = "HubValidations"),
  metadata_schema = system.file("testdata", "data-processed", "schema-metadata.yml", package = "HubValidations")
)
```
...
validate_model_data(
  ...
  data_schema = system.file("testdata", "data-processed", "schema-data.yml", package = "HubValidations")
)
```
